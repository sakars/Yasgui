...
import { default as Yasqe, PartialConfig as YasqeConfig, RequestConfig } from "@sakars/yasqe";
import { default as Yasr, Config as YasrConfig } from "@sakars/yasr";
import { addClass, removeClass } from "@sakars/yasgui-utils";
require("./index.scss");
require("@sakars/yasr/src/scss/global.scss");
if (window) {
